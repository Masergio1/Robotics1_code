...
syms alpha d  a a4 theta q1 q2 q3 q4
...
J_L_A = [p_z_0, p_z_1, p_z_2, p_z_3;
         z_0, z_1, vector_0 , z_3]

singular = simplify(J_L_A.' * J_L_A, steps = 100)
determinante_singular = simplify(det(singular), steps = 100)
...
J_L_A_sost = simplify(subs(J_L_A_mid_frame_1, [q1, q2, q3, q4], [pi/2, 0, 0, pi/2]), steps = 100) 
null_space_J_L_A = simplify(null(J_L_A_sost), steps = 100)

%theorem of carabinier aka complementarity
null_space_J_L_A = simplify(null(J_L_A_sost.'), steps = 100)
